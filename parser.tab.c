...
static const char *const yytname[] =
{
  ...
  "SEMICOLON", "ASSIGN", "PLUS", "MINUS", "NUMBER", "WRITE", "$accept",
...
{
       7,     6,    16,     1,    20,    21,     8,    17,     5,    13,
      12,    14,    15,    19,    23,    24,    11
};

static const yytype_int8 yycheck[] =
{
       4,     0,     4,     3,     7,     8,    10,     9,     4,     6,
       5,     4,    10,     5,     5,     4,     4
};
...
#line 125 "parser.y"
                  { 
						...
						(yyval.ast)->expr.left = (yyvsp[-2].string);
						(yyval.ast)->expr.right = (yyvsp[0].string);
						(yyval.ast)->expr.operator = (yyvsp[-1].ast);
